...
const Segment = React.memo(props => {
  ...
  return <TouchableOpacity onLayout={segmentOnLayout} style={segmentStyle} onPress={onSegmentPress} onLongPress={() => props.onLongPress?.(index)} row flexG center testID={`${testID}.${index}`}>
