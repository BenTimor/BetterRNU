...
declare const colorObject: Colors & {
    ...
    green70: string;
    green80: string;
    yellow1: string; /** Whether to adjust the saturation of colors with high lightness and saturation (unifying saturation level throughout palette) */
    yellow5: string;
    yellow10: string;
    yellow20: string;
    yellow30: string;
    yellow40: string;
    yellow50: string;
    yellow60: string; /** Array of saturation adjustments to apply on the color's tints array (from darkest to lightest).
     * The 'adjustSaturation' option must be true */
    yellow70: string;
    yellow80: string;
    orange1: string;
